...
public extension SKKit where Base: UIResponder {
    /// wait with your own animated images
    @discardableResult
    func pleaseWaitWithImages(_ imageNames: Array<UIImage>, timeInterval: Int) -> UIWindow{
        return SwiftTips.wait(imageNames, timeInterval: timeInterval)
    }
    // api changed from v3.3
    @discardableResult
    func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: Int = 1) -> UIWindow{
        return SwiftTips.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // old apis
    @discardableResult
    func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func infoNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return SwiftTips.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: Int = 3) -> UIWindow{
        return SwiftTips.showNoticeWithText(type, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func pleaseWait() -> UIWindow{
        return SwiftTips.wait()
    }
    @discardableResult
    func noticeOnlyText(_ text: String) -> UIWindow{
        return SwiftTips.showText(text)
    }
    func clearAllNotice() {
        SwiftTips.clear()
    }
...
class SwiftTips: NSObject {
    ...
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: Int) -> UIWindow {
        ...
        switch type {
        case .success:
            image = SwiftTipsSDK.imageOfCheckmark
        case .error:
            image = SwiftTipsSDK.imageOfCross
        case .info:
            image = SwiftTipsSDK.imageOfInfo
        }
...
class SwiftTipsSDK {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        SwiftTipsSDK.draw(NoticeType.success)
    ...
    class var imageOfCross: UIImage {
        ...
        SwiftTipsSDK.draw(NoticeType.error)
    ...
    class var imageOfInfo: UIImage {
        ...
        SwiftTipsSDK.draw(NoticeType.info)
...
extension UIWindow{
    func hide(){
        SwiftTips.hideNotice(self)
    }
}

fileprivate extension Selector {
    static let hideNotice = #selector(SwiftTips.hideNotice(_:))
}

@objc extension SwiftTips {
