...
public struct Section {
    ...
    public func sectionInset(_ inset: UIEdgeInsets) -> Section {
        var section = self
        section.sectionInset = inset
        return section
    }
    
    public func itemSpacing(_ spacing: CGFloat) -> Section {
        var section = self
        section.minimumInteritemSpacing = spacing
        return section
    }
    
    public func lineSpacing(_ spacing: CGFloat) -> Section {
        var section = self
        section.minimumLineSpacing = spacing
        return section
    }
